...
const ClientInfo = () => {
  ...
  const GetFileCabinetDetail = item => {
    console.log(item?.subClientInfo.subClientId,
      item?.subClientInfo.subClientType,
      item?.subClientInfo.subClientPracticeId, 'AAAAAAAAAAAAAAAAA', item?.subClientInfo.subClientName)
    ...
    navigation.navigate('AssoFileCabinet', {
      ...
      client: item?.subClientInfo.subClientName,
      //client: item?.subClientInfo.subClientPracticeId,
      clientName: item?.subClientInfo.subClientPracticeId
  ...
  const GetFileCabinetDetail1 = (item, firstName, lastname) => {
    console.log(item, 'KKKKKKKK', firstName, lastname)
    console.log(item?.clientId,
      item?.clientType,
      item?.client, 'UUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUU')
              ...
              {(() => {
                ...
                {item.associationType}
                          ...
                          <TouchableOpacity
                            ...
                            onPress={() => GetFileCabinetDetail1(jsonData, staffview?.firstName, staffview?.lastName)}
                          >
                            <Text
                              style={{
                                textAlign: "center",
