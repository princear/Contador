...
const MainClientDetails = ({ route }) => {
  ...
  const ClientName = MY_INFO?.staffview?.firstName + " " + MY_INFO?.staffview?.lastName
          ...
          <View
              ...
              >
                ...
                >
                  <Text
                    ...
                    style={styles.AddressText}>{MY_INFO?.officeInfo?.email}</Text>
                </TouchableOpacity>
              </Tooltip>
            ...
            <View style={{ height: 40, padding: 10, flexDirection: 'row', backgroundColor: Color.greenback }}>
              ...
              <Text
                ...
                {' '}
                {formatPhoneNumber(MY_INFO.officeInfo?.phone)}
              </Text>
